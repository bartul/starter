...
# sudo set MONO_THREADS_PER_CPU 2000
...
# Install dnx
echo "##### Install dnx #####"
sudo -u vagrant curl -sSL https://raw.githubusercontent.com/aspnet/Home/dev/dnvminstall.sh | DNX_BRANCH=dev sh
sudo -u vagrant source ~/.dnx/dnvm/dnvm.sh
dnvm install latest
